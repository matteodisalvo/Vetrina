...
TEXTS: dict[str, dict[str, str]] = {
    ...
    "status_token_refused": {
        "it": "Caricato {title}, ma GitHub ha rifiutato il token: controllalo in Info.",
        "en": "Loaded {title}, but GitHub refused the token: check it in Info.",
        "es": "Cargado {title}, pero GitHub ha rechazado el token: revísalo en Info.",
        "fr": "{title} chargé, mais GitHub a refusé le jeton : vérifiez-le dans Infos.",
        "de": "{title} geladen, aber GitHub hat das Token abgelehnt: Prüfe es unter Info.",
    },
    "status_bad_image": {
    ...
    "token_title": {"it": "Token GitHub (facoltativo)", "en": "GitHub token (optional)",
                    "es": "Token de GitHub (opcional)", "fr": "Jeton GitHub (facultatif)",
                    "de": "GitHub-Token (optional)"},
    "token_note": {
        "it": "Alza il limite di GitHub da 60 a 5.000 richieste l'ora. Resta su questo computer.",
        "en": "Raises GitHub's limit from 60 to 5,000 requests an hour. It stays on this computer.",
        "es": "Sube el límite de GitHub de 60 a 5.000 peticiones por hora. Se queda en este ordenador.",
        "fr": "Fait passer la limite de GitHub de 60 à 5 000 requêtes par heure. Il reste sur cet ordinateur.",
        "de": "Hebt GitHubs Grenze von 60 auf 5.000 Anfragen pro Stunde. Es bleibt auf diesem Computer.",
    },
    "token_cli": {
        "it": "Non serve un token: uso quello della GitHub CLI di questo computer.",
        "en": "No token needed: I use the one of this computer's GitHub CLI.",
        "es": "No hace falta un token: uso el de la GitHub CLI de este ordenador.",
        "fr": "Aucun jeton nécessaire : j'utilise celui de la GitHub CLI de cet ordinateur.",
        "de": "Kein Token nötig: Ich verwende das der GitHub CLI dieses Computers.",
    },
    "token_create": {"it": "Crea un token", "en": "Create a token", "es": "Crear un token",
                     "fr": "Créer un jeton", "de": "Token erstellen"},
    ...
    "error_rate_limited": {
        "it": "GitHub ha limitato le richieste fino alle {time}. Con un token GitHub (in Info) il limite sparisce.",
        "en": "GitHub is limiting requests until {time}. With a GitHub token (in Info) the limit goes away.",
        "es": "GitHub limita las peticiones hasta las {time}. Con un token de GitHub (en Info) el límite desaparece.",
        "fr": "GitHub limite les requêtes jusqu'à {time}. Avec un jeton GitHub (dans Infos), la limite disparaît.",
        "de": "GitHub begrenzt die Anfragen bis {time}. Mit einem GitHub-Token (unter Info) fällt die Grenze weg.",
    },
